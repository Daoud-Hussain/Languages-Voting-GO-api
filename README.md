...
```
git clone https://github.com/Daoud-Hussain/Languages-Voting-GO-api.git
```

**Create go-api Namespace**
```
...
In this Project, I learnt how to deploy a cloud native application into EKS. Once deployed and up and running, I used your local workstation's browser to test out the application. I later confirmed that my activity within the application generated data which was captured and recorded successfully within the MongoDB ReplicaSet back end within the cluster.
